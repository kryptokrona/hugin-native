...
RCT_EXPORT_METHOD(getInitialVoipPayload : (RCTPromiseResolveBlock)
...
RCT_EXPORT_METHOD(
    getWalletSyncData : (
        NSArray<NSString *> *)blockHashCheckpoints startHeight : (NSInteger)
        startHeight startTimestamp : (NSInteger)startTimestamp blockCount : (
            NSInteger)blockCount skipCoinbaseTransactions : (BOOL)
            skipCoinbaseTransactions url : (NSString *)
                url resolver : (RCTPromiseResolveBlock)
                    resolve rejecter : (RCTPromiseRejectBlock)reject) {
              ...
              completionHandler:^(NSData *data, NSURLResponse *response,
                ...
                if (httpResponse.statusCode != 200) {
                  NSString *errorMessage = [NSString
                      stringWithFormat:@"Failed to fetch, response code: %ld",
                ...
                if (BLOCK_COUNT > 1 &&
                    (responseString.length >= 2 * 1024 * 1024)) {
                  BLOCK_COUNT /= 4;
                  if (BLOCK_COUNT == 0) {
                    BLOCK_COUNT = 1;
                  }

                  NSLog(@"Response too large, retrying with BLOCK_COUNT: %ld",
                        BLOCK_COUNT);
...
RCT_EXPORT_METHOD(
    generateRingSignatures : (NSString *)prefixHash keyImage : (NSString *)
        keyImage publicKeys : (NSArray<NSString *> *)
            publicKeys transactionSecretKey : (NSString *)
                transactionSecretKey realOutput : (NSDictionary *)
                    realOutput resolver : (RCTPromiseResolveBlock)
                        resolve rejecter : (RCTPromiseRejectBlock)reject) {
  ...
  try {
    ...
    if (![realOutputIndex isKindOfClass:[NSNumber class]]) {
      reject(@"invalid_argument",
             @"realOutput must contain a valid number under 'realIndex'", nil);
      return;
    }
    ...
    bool result = Core::Cryptography::generateRingSignatures(
        cppPrefixHash, cppKeyImage, cppPublicKeys, cppTransactionSecretKey,
        cppRealOutput, cppSignatures);
    ...
    if (result) {
      ...
      NSError *error =
          [NSError errorWithDomain:@"GenerateRingSignaturesError"
                              code:1
                          userInfo:@{
                            NSLocalizedDescriptionKey :
                                @"Failed to generate ring signatures"
                          }];
...
RCT_EXPORT_METHOD(
    checkRingSignature : (NSString *)prefixHash keyImage : (NSString *)
        keyImage publicKeys : (NSArray<NSString *> *)publicKeys signatures : (
            NSArray<NSString *> *)signatures resolver : (RCTPromiseResolveBlock)
            resolve rejecter : (RCTPromiseRejectBlock)reject) {
  ...
  bool result = Core::Cryptography::checkRingSignature(
      cppPrefixHash, cppKeyImage, cppPublicKeys, cppSignatures);

  // Resolve the result back to JavaScript
  resolve(@(result));
}

RCT_EXPORT_METHOD(generateKeyDerivation : (NSString *)publicKey privateKey : (
    NSString *)privateKey resolver : (RCTPromiseResolveBlock)
                      resolve rejecter : (RCTPromiseRejectBlock)reject) {
  ...
  bool success = Core::Cryptography::generateKeyDerivation(
      cppPublicKey, cppPrivateKey, cppDerivation);
  ...
  if (success) {
    ...
    reject(@"key_derivation_failed", @"Failed to generate key derivation",
           error);
  }
}

RCT_EXPORT_METHOD(generateKeyImage : (NSString *)publicKey privateKey : (
    NSString *)privateKey resolver : (RCTPromiseResolveBlock)
                      resolve rejecter : (RCTPromiseRejectBlock)reject) {
  ...
  try {
    std::string keyImage =
        Core::Cryptography::generateKeyImage(cppPublicKey, cppPrivateKey);
    ...
    NSString *errorMessage = [NSString stringWithUTF8String:e.what()];
    NSError *error =
        [NSError errorWithDomain:@"KeyImageError"
                            code:1
                        userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
...
RCT_EXPORT_METHOD(deriveSecretKey : (NSString *)derivation outputIndex : (
    NSDictionary *)outputIndex privateKey : (NSString *)
                      privateKey resolver : (RCTPromiseResolveBlock)
                          resolve rejecter : (RCTPromiseRejectBlock)reject) {
  ...
  if (![outputIndexNumber isKindOfClass:[NSNumber class]]) {
    reject(@"invalid_argument",
           @"outputIndex must contain a valid number under the 'value' key",
           nil);
    return;
  }
  ...
  try {
    // Call the C++ function
    std::string secretKey = Core::Cryptography::deriveSecretKey(
        cppDerivation, cppOutputIndex, cppPrivateKey);
    ...
    NSString *errorMessage = [NSString stringWithUTF8String:e.what()];
    NSError *error =
        [NSError errorWithDomain:@"DeriveSecretKeyError"
                            code:1
                        userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
...
RCT_EXPORT_METHOD(derivePublicKey : (NSString *)derivation outputIndex : (
    NSDictionary *)outputIndex publicKey : (NSString *)
                      publicKey resolver : (RCTPromiseResolveBlock)
                          resolve rejecter : (RCTPromiseRejectBlock)reject) {
  ...
  try {
    ...
    if (result) {
      ...
      NSError *error =
          [NSError errorWithDomain:@"DerivePublicKeyError"
                              code:1
                          userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
...
RCT_EXPORT_METHOD(cnFastHash : (NSString *)input resolver : (
  ...
  try {
    ...
    NSString *errorMessage = [NSString stringWithUTF8String:e.what()];
    NSError *error =
        [NSError errorWithDomain:@"FastHashError"
                            code:1
                        userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
...
RCT_EXPORT_METHOD(cnTurtleLiteSlowHashV2 : (NSString *)input resolver : (
    RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)reject) {
  ...
  try {
    std::string cppHash =
        Core::Cryptography::cn_turtle_lite_slow_hash_v2(cppInput);
    ...
    NSString *errorMessage = [NSString stringWithUTF8String:e.what()];
    NSError *error =
        [NSError errorWithDomain:@"TurtleLiteSlowHashV2Error"
                            code:1
                        userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
    ...
    reject(@"cn_turtle_lite_slow_hash_v2_failed", @"Unknown error occurred",
           error);
  }
}

RCT_EXPORT_METHOD(
    findPowShare : (NSString *)blobHex targetHex : (NSString *)
        targetHex startNonce : (nonnull NSNumber *)startNonce maxAttempts : (
            nonnull NSNumber *)maxAttempts nonceTagBits : (nonnull NSNumber *)
            nonceTagBits nonceTagValue : (nonnull NSNumber *)
                nonceTagValue resolver : (RCTPromiseResolveBlock)
                    resolve rejecter : (RCTPromiseRejectBlock)reject) {
  ...
  dispatch_async(dispatch_get_global_queue(QOS_CLASS_UTILITY, 0), ^{
    @autoreleasepool {
      try {
        ...
        auto readVarint = [](const std::vector<uint8_t> &buffer, size_t offset,
                             uint64_t &value, size_t &consumed) -> bool {
          value = 0;
          consumed = 0;
          int shift = 0;
        ...
        auto getNonceOffset =
            [&](const std::vector<uint8_t> &blobBytes) -> size_t {
          constexpr size_t fallbackOffset = 39;
          size_t offset = 0;
          uint64_t value = 0;
          size_t consumed = 0;
          if (!readVarint(blobBytes, offset, value, consumed))
        ...
        auto getTargetValue = [&](const std::string &targetHexValue,
                                  bool &valid) -> uint64_t {
          valid = false;
          if (targetHexValue.size() != 8)
            return 0;
          std::vector<uint8_t> targetBytes;
          if (!hexToBytes(targetHexValue, targetBytes) ||
              targetBytes.size() != 4)
            return 0;
        ...
        if (attempts == 0)
          attempts = 1;
        if (attempts > MAX_POW_ATTEMPTS)
          attempts = MAX_POW_ATTEMPTS;
        ...
        const unsigned int cpuCount =
            (unsigned int)[[NSProcessInfo processInfo] activeProcessorCount];
        const unsigned int targetThreads =
            std::max(1u, (unsigned int)(cpuCount * 0.5));
        const unsigned int numThreads = std::min(targetThreads, maxThreads);

        // Shared state across threads (use shared_ptr because ObjC blocks
        // copy-capture)
        auto found = std::make_shared<std::atomic<bool>>(false);
        auto totalHashes = std::make_shared<std::atomic<uint64_t>>(0);
        __block uint32_t winningNonceRaw = 0;
        __block std::string winningHashHex;

        dispatch_group_t group = dispatch_group_create();
        dispatch_queue_t minerQueue =
            dispatch_queue_create("pow.miner", DISPATCH_QUEUE_CONCURRENT);

        const uint64_t attemptsPerThread =
            (attempts + numThreads - 1) / numThreads;
        ...
        for (unsigned int t = 0; t < numThreads; t++) {
          dispatch_group_async(group, minerQueue, ^{
            ...
            uint32_t localNonce =
                startNonce32 + (uint32_t)(t * attemptsPerThread);
            ...
            for (uint64_t i = 0; i < attemptsPerThread; i++) {
              ...
              localBlob[nonceOffset + 1] =
                  static_cast<uint8_t>((localNonce >> 8) & 0xff);
              localBlob[nonceOffset + 2] =
                  static_cast<uint8_t>((localNonce >> 16) & 0xff);
              localBlob[nonceOffset + 3] =
                  static_cast<uint8_t>((localNonce >> 24) & 0xff);

              Crypto::Hash hashResult;
              Crypto::cn_turtle_lite_slow_hash_v2(localBlob.data(),
                                                  localBlob.size(), hashResult);
              ...
              if (hashTail <= targetValue) {
                ...
                if (found->compare_exchange_strong(expected, true)) {
                  winningNonceRaw = localNonce;
                  std::vector<uint8_t> hashBytesVec(hashResult.data,
                                                    hashResult.data + 32);
        ...
        if (found->load()) {
          NSString *winnerNonce = [NSString
              stringWithFormat:@"%02x%02x%02x%02x",
                               static_cast<uint8_t>(winningNonceRaw & 0xff),
                               static_cast<uint8_t>((winningNonceRaw >> 8) &
                                                    0xff),
                               static_cast<uint8_t>((winningNonceRaw >> 16) &
                                                    0xff),
                               static_cast<uint8_t>((winningNonceRaw >> 24) &
                                                    0xff)];
          NSString *winnerResult =
              [NSString stringWithUTF8String:winningHashHex.c_str()];
        ...
        NSError *error = [NSError
            errorWithDomain:@"FindPowShareError"
                       code:1
                   userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
...
void processTransactionOutputs(
    const RawTransaction &tx, const Crypto::SecretKey &privateViewKey,
  ...
  /* Generate the key derivation from the random tx public key, and our private
     view key */
  Crypto::crypto_funcs::generate_key_derivation(tx.transactionPublicKey,
  ...
  for (const auto &output : tx.keyOutputs) {
    ...
    /* Derive the public spend key from the transaction, using the previous
       derivation */
    Crypto::crypto_funcs::underive_public_key(derivation, outputIndex,
                                              output.key, derivedSpendKey);
    ...
    if (ourPrivateSpendKey != spendKeys.end()) {
      ...
      if (!isViewWallet) {
        ...
        Crypto::crypto_funcs::derive_public_key(derivation, outputIndex,
                                                derivedSpendKey, tmpPublicKey);
        ...
        Crypto::crypto_funcs::generate_key_image(tmpPublicKey, tmpSecretKey,
                                                 input.keyImage);
      }
...
processBlockOutputsiOS(
  ...
  if (processCoinbaseTransactions && block.coinbaseTransaction) {
    processTransactionOutputs(*block.coinbaseTransaction, privateViewKey,
                              spendKeys, isViewWallet, inputs);
  }

  /* Process the normal txs */
  for (const auto &tx : block.transactions) {
    processTransactionOutputs(tx, privateViewKey, spendKeys, isViewWallet,
                              inputs);
  }
...
RCT_EXPORT_METHOD(
    processBlockOutputs : (NSDictionary *)block privateViewKey : (NSString *)
        privateViewKey spendKeys : (NSArray *)spendKeys // Changed to NSArray
            isViewWallet : (BOOL)isViewWallet processCoinbaseTransactions : (
                BOOL)
                processCoinbaseTransactions resolver : (RCTPromiseResolveBlock)
                    resolve rejecter : (RCTPromiseRejectBlock)reject) {
  ...
  try {
    ...
    inputs = processBlockOutputsiOS(
        ...
        cppSpendKeys,            // std::unordered_map<Crypto::PublicKey,
                                 // Crypto::SecretKey>
    ...
    NSString *errorMessage = [NSString stringWithUTF8String:e.what()];
    NSError *error =
        [NSError errorWithDomain:@"processBlockOutputsError"
                            code:1
                        userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
...
RCT_EXPORT_METHOD(scReduce32 : (NSString *)data resolver : (
    RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)reject) {
  try {
    ...
    NSString *errorMessage = [NSString stringWithUTF8String:e.what()];
    NSError *error =
        [NSError errorWithDomain:@"scReduce32Error"
                            code:1
                        userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
...
RCT_EXPORT_METHOD(secretKeyToPublicKey : (NSString *)privateKey resolver : (
    RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)reject) {
  try {
    // Convert the input NSString to a C++ std::string
    std::string cppPrivateKey = [privateKey UTF8String];
    ...
    // Call the C++ function
    bool success =
        Core::Cryptography::secretKeyToPublicKey(cppPrivateKey, cppPublicKey);

    // Check if the function was successful
    if (success) {
      // Convert the public key std::string to NSString and resolve the promise
      NSString *publicKey =
          [NSString stringWithUTF8String:cppPublicKey.c_str()];
      resolve(publicKey);
    } else {
      // Handle the case where the conversion failed
      NSString *errorMessage = @"Failed to convert secret key to public key";
      NSError *error =
          [NSError errorWithDomain:@"SecretKeyToPublicKeyError"
                              code:1
                          userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
    ...
    reject(@"secret_key_to_public_key_failed", @"Unknown error occurred",
           error);
  }
}

RCT_EXPORT_METHOD(checkKey : (NSString *)publicKey resolver : (
    RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)reject) {
  try {
    // Convert the input NSString to a C++ std::string
    std::string cppPublicKey = [publicKey UTF8String];
    ...
    NSString *errorMessage = [NSString stringWithUTF8String:e.what()];
    NSError *error =
        [NSError errorWithDomain:@"CheckKeyError"
                            code:1
                        userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
...
RCT_EXPORT_METHOD(hashToEllipticCurve : (NSString *)hash resolver : (
    RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)reject) {
  try {
    // Convert the input NSString to a C++ std::string
    ...
    // Call the C++ function
    std::string ellipticCurveHex =
        Core::Cryptography::hashToEllipticCurve(cppHash);
    ...
    NSString *errorMessage = [NSString stringWithUTF8String:e.what()];
    NSError *error =
        [NSError errorWithDomain:@"HashToEllipticCurveError"
                            code:1
                        userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
...
RCT_EXPORT_METHOD(generateSignature : (NSString *)prefixHash publicKey : (
    NSString *)publicKey privateKey : (NSString *)
                      privateKey resolver : (RCTPromiseResolveBlock)
                          resolve rejecter : (RCTPromiseRejectBlock)reject) {
  try {
    ...
    std::string signatureHex = Core::Cryptography::generateSignature(
        cppPrefixHash, cppPublicKey, cppPrivateKey);
    ...
    NSString *errorMessage = [NSString stringWithUTF8String:e.what()];
    NSError *error =
        [NSError errorWithDomain:@"GenerateSignatureError"
                            code:1
                        userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
...
RCT_EXPORT_METHOD(checkSignature : (NSString *)prefixHash publicKey : (
    NSString *)publicKey signature : (NSString *)
                      signature resolver : (RCTPromiseResolveBlock)
                          resolve rejecter : (RCTPromiseRejectBlock)reject) {
  try {
    // Convert the input NSStrings to std::strings
    std::string cppPrefixHash = [prefixHash UTF8String];
    ...
    bool isValid = Core::Cryptography::checkSignature(
        cppPrefixHash, cppPublicKey, cppSignature);
    ...
    NSString *errorMessage = [NSString stringWithUTF8String:e.what()];
    NSError *error =
        [NSError errorWithDomain:@"CheckSignatureError"
                            code:1
                        userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
...
RCT_EXPORT_METHOD(hashToScalar : (NSString *)hash resolver : (
    RCTPromiseResolveBlock)resolve rejecter : (RCTPromiseRejectBlock)reject) {
  try {
    ...
    NSString *errorMessage = [NSString stringWithUTF8String:e.what()];
    NSError *error =
        [NSError errorWithDomain:@"HashToScalarError"
                            code:1
                        userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
...
RCT_EXPORT_METHOD(underivePublicKey : (NSString *)derivation outputIndex : (
    nonnull NSNumber *)outputIndex derivedKey : (NSString *)
                      derivedKey resolver : (RCTPromiseResolveBlock)
                          resolve rejecter : (RCTPromiseRejectBlock)reject) {
  try {
    ...
    if (success) {
      ...
      NSError *error =
          [NSError errorWithDomain:@"UnderivePublicKeyError"
                              code:1
                          userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
...
RCT_EXPORT_METHOD(generateKeys : (RCTPromiseResolveBlock)
                      resolve rejecter : (RCTPromiseRejectBlock)reject) {
  try {
    ...
    NSString *errorMessage = [NSString stringWithUTF8String:e.what()];
    NSError *error =
        [NSError errorWithDomain:@"GenerateKeysError"
                            code:1
                        userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
...
RCT_EXPORT_METHOD(generateDeterministicSubwalletKeys : (
    NSString *)basePrivateKey walletIndex : (nonnull NSNumber *)
                      walletIndex resolver : (RCTPromiseResolveBlock)
                          resolve rejecter : (RCTPromiseRejectBlock)reject) {
  try {
    // Convert Objective-C types to C++ types
    ...
    if (success) {
      ...
      NSString *publicKey =
          [NSString stringWithUTF8String:cppPublicKey.c_str()];
      NSString *privateKey =
          [NSString stringWithUTF8String:cppPrivateKey.c_str()];
      ...
      NSString *errorMessage =
          @"Failed to generate deterministic subwallet keys";
      NSError *error =
          [NSError errorWithDomain:@"GenerateSubwalletKeysError"
                              code:1
                          userInfo:@{NSLocalizedDescriptionKey : errorMessage}];
...
NSDictionary *transactionInputToNS(const TransactionInput &input) {
  ...
  return @{
    ...
    @"parentTransactionHash" :
        [NSString stringWithUTF8String:input.parentTransactionHash.c_str()]
  };
}

// Convert std::vector<std::tuple<PublicKey, TransactionInput>> to NSArray
NSArray *convertInputsToNSArray(
    const std::vector<std::tuple<Crypto::PublicKey, TransactionInput>>
        &inputs) {
  ...
  for (const auto &[publicSpendKey, input] : inputs) {
    ...
    [result addObject:@{
      @"publicSpendKey" :
          [NSString stringWithUTF8String:publicSpendKeyHex.c_str()],
...
WalletBlockInfo convertWalletBlockInfo(NSDictionary *block) {
  ...
  if (coinbaseTransaction && ![coinbaseTransaction isEqual:[NSNull null]]) {
    ...
    const char *publicKeyHex =
        [coinbaseTransaction[@"transactionPublicKey"] UTF8String];
    Crypto::PublicKey publicKey = Crypto::PublicKey();
    Common::podFromHex(publicKeyHex, publicKey);

    parsedCoinbaseTransaction.keyOutputs =
        parseKeyOutputs(coinbaseTransaction[@"keyOutputs"]);
